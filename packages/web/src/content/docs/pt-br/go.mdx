...
O plano foi projetado principalmente para usuários internacionais e oferece acesso global estável. Seus dados não serão usados para treinamento de modelos.
