export const dict = {
  ...
  "provider.connect.apiKey.description": "اپنا اکاؤنٹ منسلک کرنے اور OpenCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.opencodeZen.line2": "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  ...
  "provider.connect.oauth.code.visit.suffix": "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور OpenCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix": " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور OpenCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.custom.field.apiKey.description": "اختیاری۔ اگر آپ ہیڈرز کے ذریعے توثیق کا انتظام کرتے ہیں تو اسے خالی چھوڑ دیں۔",
  ...
  "dialog.server.default.description": "مقامی سرور شروع کرنے کے بجائے ایپ لانچ پر اس سرور سے جڑیں۔ دوبارہ شروع کرنے کی ضرورت ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ OpenCode WSL سرور شامل کر سکے۔",
  ...
  "wsl.onboarding.windowsRestartRequired": "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر OpenCode کو دوبارہ کھولیں۔",
  ...
  "error.dev.rootNotFound": "روٹ عنصر نہیں ملا۔ کیا آپ اسے اپنے index.html میں شامل کرنا بھول گئے؟ یا ہو سکتا ہے کہ آئی ڈی وصف کی ہجے غلط ہو گئی ہو؟",
  ...
  "error.chain.configDirectoryTypo": "{{path}} میں ڈائریکٹری \"{{dir}}\" درست نہیں ہے۔ ڈائریکٹری کا نام \"{{suggestion}}\" رکھیں یا اسے ہٹا دیں۔ یہ املا کی ایک عام غلطی ہے۔",
  ...
  "session.review.noVcs.createGit.description": "اس پروجیکٹ میں تبدیلیوں کو ٹریک کریں، ان کا جائزہ لیں اور ان کو کالعدم کریں۔",
  ...
  "session.review.noSnapshot": "اسنیپ شاٹ سے باخبر رہنے کی ترتیب کو غیر فعال کر دیا گیا ہے، لہذا سیشن کی تبدیلیاں دستیاب نہیں ہیں۔",
  ...
  "session.share.popover.description.unshared": "ویب پر عوامی طور پر سیشن کا اشتراک کریں۔ یہ لنک کے ساتھ ہر کسی کے لیے قابل رسائی ہو گا۔",
  ...
  "debugBar.nav.tip": "سیشن صفحے سے متعلق آخری مکمل روٹ منتقلی، جسے روٹر کے آغاز سے منتقلی مکمل ہونے کے بعد پہلی بار اسکرین بننے تک ناپا گیا ہے۔",
  ...
  "settings.general.row.colorScheme.description": "منتخب کریں کہ آیا OpenCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  ...
  "settings.general.row.followup.description": "منتخب کریں کہ آیا فالو اپ فوری طور پر آگے بڑھتا ہے یا قطار میں انتظار کرتا ہے۔",
  ...
  "settings.general.row.showCustomAgents.description": "کمپوزر میں ایجنٹس تبدیل کریں۔ چھپانے پر Build ایجنٹ بطور طے شدہ استعمال ہوگا۔",
  ...
  "settings.general.row.shellToolPartsExpanded.description": "ٹائم لائن میں شیل ٹول کے حصے بطور طے شدہ پھیلے ہوئے دکھائیں۔",
  "settings.general.row.editToolPartsExpanded.title": "ترمیمی ٹول کے حصے پھیلائیں",
  "settings.general.row.editToolPartsExpanded.description": "ٹائم لائن میں ترمیم، تحریر اور پیچ ٹول کے حصے بطور طے شدہ پھیلے ہوئے دکھائیں۔",
  "settings.general.row.newInterface.title": "نیا لے آؤٹ",
  "settings.general.row.newInterface.badge": "نیا",
  "settings.general.row.newInterface.description": "نئے ٹیبز اور ہوم لے آؤٹ استعمال کریں۔ ایک محدود وقت کے لیے لے آؤٹ کے درمیان سوئچ کریں۔",
  ...
  "settings.general.row.wayland.tooltip": "مخلوط ریفریش ریٹ مانیٹر کے ساتھ Linux پر، مقامی Wayland زیادہ مستحکم ہو سکتا ہے۔",
