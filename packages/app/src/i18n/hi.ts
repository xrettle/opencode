export const dict = {
  ...
  "provider.connect.apiKey.description": "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और OpenCode में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  ...
  "provider.connect.oauth.code.visit.suffix": " अपने खाते को कनेक्ट करने और OpenCode में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix": " और अपने खाते को कनेक्ट करने तथा OpenCode में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "provider.custom.field.apiKey.description": "वैकल्पिक। यदि आप हेडर के माध्यम से प्रमाणीकरण प्रबंधित करते हैं तो खाली छोड़ दें।",
  ...
  "dialog.server.default.description": "स्थानीय सर्वर शुरू करने के बजाय ऐप लॉन्च होने पर इस सर्वर से कनेक्ट करें। पुनः आरंभ करना आवश्यक है।",
  ...
  "wsl.onboarding.wslNotInstalled.description": "OpenCode द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  ...
  "wsl.onboarding.windowsRestartRequired": "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर OpenCode को फिर से खोलें।",
  ...
  "error.dev.rootNotFound": "मूल तत्व नहीं मिला. क्या आप इसे अपने index.html में जोड़ना भूल गए? या हो सकता है कि आईडी विशेषता गलत वर्तनी हो गई हो?",
  ...
  "error.chain.mcpFailed": "MCP सर्वर \"{{name}}\" विफल रहा। ध्यान दें, OpenCode अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।",
  "error.chain.providerAuthFailed": "प्रोवाइडर प्रमाणीकरण विफल ({{provider}}): {{message}}",
  "error.chain.providerInitFailed": "प्रोवाइडर \"{{provider}}\" शुरू नहीं किया जा सका। क्रेडेंशियल और कॉन्फ़िगरेशन की जाँच करें।",
  ...
  "error.chain.configDirectoryTypo": "{{path}} में निर्देशिका \"{{dir}}\" मान्य नहीं है। निर्देशिका का नाम बदलकर \"{{suggestion}}\" करें या इसे हटा दें। यह वर्तनी की एक सामान्य त्रुटि है।",
  ...
  "session.share.popover.description.shared": "यह सेशन वेब पर सार्वजनिक है। यह लिंक वाले किसी भी व्यक्ति के लिए सुलभ है।",
  "session.share.popover.description.unshared": "सेशन को वेब पर सार्वजनिक रूप से साझा करें। यह लिंक वाले किसी भी व्यक्ति के लिए सुलभ होगा।",
  ...
  "debugBar.nav.tip": "सेशन पृष्ठ को छूते हुए अंतिम पूर्ण मार्ग परिवर्तन, राउटर प्रारंभ से लेकर उसके व्यवस्थित होने के बाद पहले पेंट तक मापा जाता है।",
  ...
  "settings.general.row.followup.description": "चुनें कि क्या अनुवर्ती प्रॉम्प्ट तुरंत आगे बढ़ेगा या कतार में प्रतीक्षा करेगा",
  ...
  "settings.general.row.showCustomAgents.description": "कंपोज़र में एजेंट के बीच स्विच करें। छिपाए जाने पर, डिफ़ॉल्ट रूप से बिल्ड एजेंट हो जाता है।",
  ...
  "settings.general.row.shellToolPartsExpanded.description": "टाइमलाइन में डिफ़ॉल्ट रूप से विस्तारित शेल टूल पार्ट्स दिखाएं",
  "settings.general.row.editToolPartsExpanded.title": "संपादन टूल भागों का विस्तार करें",
  "settings.general.row.editToolPartsExpanded.description": "टाइमलाइन में डिफ़ॉल्ट रूप से विस्तारित संपादित करें, लिखें और पैच टूल पार्ट्स दिखाएं",
  "settings.general.row.newInterface.title": "नया लेआउट",
  "settings.general.row.newInterface.badge": "नया",
  "settings.general.row.newInterface.description": "नए टैब और होम लेआउट का उपयोग करें. सीमित समय के लिए लेआउट के बीच स्विच करें।",
  ...
  "settings.general.row.wayland.tooltip": "अलग-अलग रीफ़्रेश दर वाले मॉनिटर के साथ Linux पर नेटिव Wayland अधिक स्थिर हो सकता है।",
  ...
  "settings.general.notifications.agent.description": "जब एजेंट पूरा हो जाए या ध्यान देने की आवश्यकता हो तो सिस्टम अधिसूचना दिखाएं",
